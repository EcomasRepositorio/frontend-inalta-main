        ...
        <div className="relative">
          <Suspense fallback={<DashboardSkeleton />}>
            <Image
              src={curso.imagen}
              alt="ecommerce"
              width={600} // Ajusta el tamaño aquí
              height={400} // Ajusta el tamaño aquí
              className="object-cover w-full h-full" // Cambia las clases si es necesario
            />
          </Suspense>
        </div>
        <div className="p-8 flex flex-col justify-between">
          <div>
            <h2 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider mb-2">{curso.area}</h2>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{curso.titulo}</h1>
            <Accordion defaultExpandedKeys={["1"]} bordered shadow>
              <AccordionItem key="1" title={<h3 className="text-lg font-medium text-gray-900 dark:text-white">Detalles del diplomado</h3>}>
                <div className="grid grid-cols-2 gap-4 text-gray-700 dark:text-gray-300">
                  ...
                  <div>
                    <p className="font-bold">Tiempo de duración:</p>
                    <p>{curso.duracion}</p>
                  </div>
                  <div>
              ...
              <AccordionItem key="2" title={<h3 className="text-lg font-medium text-gray-900 dark:text-white">¿A quiénes está dirigido?</h3>}>
                <p className="text-gray-700 dark:text-gray-300">{curso.descripcion}</p>
              </AccordionItem>

              <AccordionItem key="3" title={<h3 className="text-lg font-medium text-gray-900 dark:text-white">Módulos del diplomado</h3>}>
          ...
          <div className="flex mt-6">
            ...
            <button className="flex-1 flex items-center justify-center bg-[#25D366] text-white hover:bg-[#25D344] rounded-lg py-2 px-6">
            <svg className="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 512 512">
            ...
            <a href="https://wa.me/51921818181" target="_blank">
              <button className="flex-1 flex items-center justify-center bg-primaryblue text-white hover:bg-[#0060dd] rounded-lg py-2 px-4 w-full">
                <svg className="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24">
            ...
            <Link href="/certs" className="flex-1"> {/* Cambia el enlace a interno */}
              <button className="flex-1 flex items-center justify-center bg-[#FFD700] text-white hover:bg-[#FFC107] rounded-lg py-2 px-4 w-full">
                <svg className="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 512 512">
