          ...
          <div className="lg:w-1/2 lg:pl-10 lg:py-6 mb-6 lg:mb-0">
            ...
            <Accordion defaultExpandedKeys={["1"]}>
              <AccordionItem key="1" aria-label="Accordion 1" subtitle=""
                title={
                  <h2 className='text-blackblue dark:text-dark'>Detalles del diplomado</h2>
                }>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="font-bold text-blackblue dark:text-dark">Fecha de inicio: <span className="font-normal dark:text-dark">{curso.fechaInicio}</span></p>
                  </div>
                  <div>
                    <p className="font-bold text-blackblue dark:text-dark">Modalidad: <span className="font-normal dark:text-dark">{curso.modalidad}</span></p>
                  </div>
                  <div>
                    <p className="font-bold text-blackblue dark:text-dark">Tiempo de duración: <span className="font-normal dark:text-dark">{curso.duracion}</span></p>
                  </div>
                  <div>
                    <p className="font-bold text-blackblue dark:text-dark">Horas del curso: <span className="font-normal dark:text-dark">{curso.horas}</span></p>
                  </div>
                </div>
            ...
            <AccordionItem
              ...
              title={
                <h2 className='text-blackblue dark:text-dark'>¿A quiénes está dirigido este diplomado?</h2>
              }
            >
            ...
            <AccordionItem key="3" aria-label="Accordion 3" subtitle=""
              title={
                <h2 className='text-blackblue dark:text-dark'>¿Con qué módulos cuenta el diplomado?</h2>
              }>
              <ul className="list-disc pl-5 text-gray-800 dark:text-dark">
