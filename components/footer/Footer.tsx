...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-purple-900 to-blue-900 text-white py-8">
        ...
        <div className= "mr-12 hidden lg:block">
          ...
          <div className="flex justify-end">
            <a href="#" className="text-white hover:text-gray-300">
              <FaFacebookF size={24} href="https://web.facebook.com/BinexEdu" />
            </a>
            <a href="#" className="text-white hover:text-gray-300">
              <FaInstagram size={24} />
            </a>
        ...
        <div className="border-t border-white/40 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-1 flex flex-col items-center md:items-start">
              <Image src="/imagenes/BINEX-logo.png" alt="Binex" width={150} height={75} />
            ...
            <div className="md:col-span-1">
              ...
              <ul className="space-y-4">
                <li className="flex items-center">
                  ...
                  <a href="mailto:capacitaciones@binex.edu.pe" className="hover:underline">capacitaciones@binex.edu.pe</a>
                </li>
                <li className="flex items-center">
                  <HiOutlinePhone size={20} className="mr-2" />
                  <a href="tel:+51984040264" className="hover:underline">+51 984 040 264</a>
                </li>
              </ul>
            </div>
          </div>
