        ...
        >
          {testimonios.map((testimonio, index) => (
            <SwiperSlide key={index}>
              {/* Establecer flex-grow para ajustar la altura */}
              <div className="flex h-[500px] justify-center flex-col items-center p-2 bg-white dark:bg-[#27272A] rounded-lg shadow-lg border border-gray-200 dark:border-gray-600  min-w-64">
              <img
                  src={testimonio.foto}
                  alt={testimonio.nombre}
                  className="w-24 h-24 rounded-full object-cover border-2 border-gray-300 dark:border-gray-600 mb-6"
                />
