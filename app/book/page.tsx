...
const Book = () => {
  ...
  const onSubmit: SubmitHandler<any> = async (data, event) => {
    ...
    console.log(data);
    setSending(true);
    const serviceID = "service_vsed7so";
  ...
  return (
    <section className='mt-'>
      ...
      <div className='p-2'>
        ...
        <p className='text-center mb-2 text-customOrange font-semibold'>Corporación Inalta</p>
        <h2 className='bg-blue-500 p-3 text-lg font-semibold text-gray-50 rounded-xl'>Identificación del consumidor</h2>
      </div>
    <form ref={refForm} onSubmit={handleSubmit(onSubmit)} className='grid grid-cols-1 md:grid-cols-2 gap-4 p-2'>
      ...
      <div className='md:col-span-2'>
        <h2 className='bg-blue-500 p-3 text-lg font-semibold text-gray-50 rounded-xl'>Detalle de la reclamación y pedido del consumidor</h2>
