...
const SearchCode = dynamic(() => import("@/components/certificate/SearchCode"), { suspense: true });
const SearchDNI = dynamic(() => import("@/components/certificate/SearchDNI"), { suspense: true });
const SearchName = dynamic(() => import("@/components/certificate/SearchName"), { suspense: true });

// Componente memoizado para evitar re-renders innecesarios
const Logo = memo(({ src, alt, width, height }: { src: string; alt: string; width: number; height: number }) => (
  <div className="relative flex justify-center items-center w-full" style={{ height, width }}>
    <Image
      src={src}
      alt={alt}
      fill
  ...
  return (
    <section className="relative bg-fixed bg-cover bg-center min-h-[400px] w-full bg-[url('/image/panorama.jpg')]">
      ...
      <div className="relative py-12 mx-auto max-w-screen-lg px-4 w-full">
        <div className="backdrop-blur-md bg-transparent rounded-lg shadow-lg p-8 md:p-12 mb-12 w-full">
          ...
          <div className="flex justify-center items-center gap-12 mb-6 w-full">
            ...
            <Logo src="/image/inaltlogwhite.png" alt="Logo Inalta" width={200} height={200} />

            {/* Logotipo de la Universidad Nacional de Piura */}
            <Logo src="/image/uni_dark.png" alt="UNP" width={200} height={200} />
          </div>

          {/* Título y Pestañas */}
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-100 mb-6 md:text-4xl">VERIFICAR CERTIFICADO</h2>
            <p className="text-gray-100 text-lg mb-8">
              Verifica la validez de tu certificado introduciendo tu DNI, nombre completo o código de certificado. Nos
              esforzamos en proteger la privacidad y el manejo confidencial de tus datos personales.
            </p>
            ...
            <Tabs
              ...
              color="secondary"
              classNames={{
                tabList: "w-full flex flex-col md:flex-row bg-transparent border border-gray-300/40",
