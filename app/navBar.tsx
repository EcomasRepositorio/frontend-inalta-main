  ...
  return (
    <>
      ...
      >
        ...
        <Link href="/">
          <Logo src="/image/logo_inal_vert.png" alt="Logo Inalta" width={210} height={150} />
        </Link>
      ...
      <Navbar isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen} className="z-20 bg-gradient-to-b from-blue-600 to-blue-400" position="sticky">
        <NavbarContent className="sm:hidden w-full" justify="center">
          <NavbarMenuToggle aria-label={isMenuOpen ? "Close menu" : "Open menu"} />
          <NavbarBrand>
            <div className="flex items-center justify-between w-full">
              <Link href="/">
                <Logo src="/image/logo_inal_vert.png" alt="Logo Inalta" width={130} height={150} />
              </Link>
              <div>
                <Link href="/certs">
        ...
        <NavbarMenu>
          {menuItems.map((link, index) => (
            <NavbarMenuItem key={index}>
              <Link href={link.href} onClick={handleMenuItemClick} className="w-full">
          ...
          <div className="flex justify-center w-full my-4">
            <Link href="/login">
              <UserCircleIcon width={40} height={40} onClick={handleMenuItemClick} />
            </Link>
          </div>
        </NavbarMenu>
      </Navbar>
